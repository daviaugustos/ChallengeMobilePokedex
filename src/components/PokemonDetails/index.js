...
import { HeaderPane, Container, StatsTitle, styles } from './style';
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const normalizePokeData = ({ stats, abilities }) => {
        const onlyRequiredStats = stats.filter(
          (item) =>
            !(
  ...
  return (
    <Container color={selectedPokemon.color}>
      ...
      <HeaderPane color={selectedPokemon.color}>
        <ImageBackground
          source={pokemonPhotoBackground}
          style={styles.pokemonPhotoBackground}
        >
        ...
        <View style={styles.statsView}>
          ...
          <View style={styles.statsDataView}>
            ...
            <View style={styles.statView}>
              ...
              <Text style={styles.totalUnitText}>
                {pokemonStats.reduce(
          ...
          <StatsTitle color={selectedPokemon.color}>
            Pokédex Abilities
          </StatsTitle>
          <View>
